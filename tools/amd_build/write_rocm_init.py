...
Usage examples, choosing a rocm Python package version to check for during init:
    ...
    * Use a specific version or pattern:
        ...
        ```
        python ./tools/amd_build/write_rocm_init.py --rocm-version 7.0.0rc20250804
...
DEFAULT_ROCM_SDK_VERSION = "7.0.0rc20250804"
...
if __name__ == "__main__":
  ...
  * an explicit version (or pattern) like '7.0.0rc20250804' or '7.0.*'
