...
MempoolId_t graph_pool_handle() {
  ...
  return c10::hip::MemPool::graph_pool_handle();
}
...
void CUDAGraph::capture_begin(MempoolId_t pool/*=0*/, hipStreamCaptureMode capture_mode) {
  ...
  if (pool.first != 0 || pool.second != 0) {
    ...
    mempool_id_ = c10::hip::MemPool::graph_pool_handle(false);
  ...
  c10::hip::HIPCachingAllocator::beginAllocateToPool(capture_dev_, mempool_id_, [this](hipStream_t stream) {
...
void CUDAGraph::capture_end() {
  ...
  c10::hip::HIPCachingAllocator::endAllocateToPool(capture_dev_, mempool_id_);
...
void CUDAGraph::instantiate() {
  ...
  if (version < 11040) {
    ...
    AT_CUDA_CHECK(hipGraphInstantiate(&graph_exec_, graph_, 0));
#else
...
void CUDAGraph::reset() {
  ...
  if (capture_ended_) {
    ...
    c10::hip::HIPCachingAllocator::releasePool(capture_dev_, mempool_id_);
