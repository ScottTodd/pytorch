...
#else // USE_ROCM
  TORCH_CHECK(false, "at::native::adaptive_avg_pool2d_quantized_cuda: ATen not compiled with USE_ROCM support");
...
#endif // AT_CUDNN_ENABLED()
#else // USE_ROCM
  TORCH_CHECK(false, "at::native::quantized_max_pool2d_cudnn: ATen not compiled with USE_ROCM support");
  return Tensor{}; // never reached, placates the compiler
#endif
}
