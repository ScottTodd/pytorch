...
class C10_HIP_API HIPAllocatorConfig {
 public:
  ...
  C10_DEPRECATED_MESSAGE(
      "c10::hip::HIPCachingAllocator::HIPAllocatorConfig::max_non_split_rounding_size() is deprecated. Please use c10::CachingAllocator::AcceleratorAllocatorConfig::max_non_split_rounding_size() instead.")
