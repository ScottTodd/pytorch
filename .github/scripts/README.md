...
New runner types can be added by committing changes to [`test-infra/.github/scale-config.yml`](https://github.com/pytorch/test-infra/blob/main/.github/scale-config.yml). Example: https://github.com/pytorch/pytorch/pull/70474

> NOTE: New runner types can only be used once the changes to [`test-infra/.github/scale-config.yml`](https://github.com/pytorch/test-infra/blob/main/.github/scale-config.yml) have made their way into the default branch
