...
# If you want to build with ROCm, run this with BUILD_ENVIRONMENT=windows-rocm-*
...
# DO NOT SUBMIT - skip this on ROCm generally? Or is it okay to keep on CI machines but not local?
# set +ex
